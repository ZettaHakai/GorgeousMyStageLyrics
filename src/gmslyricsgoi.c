...
static s16 scenario_text_000C[] = {
    ...
    CHR_A,CHR_l,CHR_l,
    PCT_SPACE,
    CHR_s,CHR_t,CHR_r,CHR_a,CHR_y,
    PCT_SPACE,
    CHR_l,CHR_a,CHR_m,CHR_b,CHR_s,
    PCT_SPACE,
    CHR_s,CHR_e,CHR_a,CHR_r,CHR_c,CHR_h,CHR_i,CHR_n,CHR_g,
    PCT_SPACE,
    CHR_s,CHR_h,CHR_e,CHR_p,CHR_a,CHR_r,CHR_d,CHR_s,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_0018[] = {
    ...
    PCT_COMMA,
    PCT_SPACE,
    CHR_l,CHR_o,CHR_o,CHR_k,
    PCT_SPACE,
    CHR_a,CHR_n,CHR_d,
    PCT_SPACE,
    CHR_b,CHR_e,CHR_h,CHR_o,CHR_l,CHR_d,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_0038[] = {
    ...
    CTR_EM_RED,
    PCT_SPACE,PCT_SPACE,PCT_SPACE,
    CHR_G,CHR_o,CHR_r,CHR_g,CHR_e,CHR_o,CHR_u,CHR_s,
    CTR_CLOSE_EM,
    PCT_SPACE,PCT_SPACE,
    CTR_EM_BLUE,
    CHR_G,CHR_o,CHR_r,CHR_g,CHR_e,CHR_o,CHR_u,CHR_s,
...
static s16 scenario_text_0048[] = {
    PCT_SPACE,CTR_EM_RED,
    CHR_L,CHR_i,CHR_k,CHR_e,
    PCT_SPACE,
    CHR_r,CHR_o,CHR_s,CHR_e,
    PCT_SPACE,
    CHR_b,CHR_l,CHR_o,CHR_o,CHR_m,
    PCT_SPACE,
    CHR_i,CHR_n,
    PCT_SPACE,
    CHR_t,CHR_h,CHR_e,
    PCT_SPACE,
    CHR_f,CHR_i,CHR_e,CHR_l,CHR_d,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_0060[] = {
    PCT_SPACE,CTR_EM_RED,
    PCT_SPACE,
    CHR_S,CHR_w,CHR_e,CHR_e,CHR_t,CHR_e,CHR_s,CHR_t,
    PCT_SPACE,
    CHR_f,CHR_r,CHR_a,CHR_g,CHR_r,CHR_a,CHR_n,CHR_c,CHR_e,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_0078[] = {
    PCT_SPACE,CTR_EM_RED,
    CHR_W,CHR_r,CHR_a,CHR_p,CHR_p,CHR_i,CHR_n,CHR_g,
    PCT_SPACE,
    CHR_u,CHR_s,
    PCT_SPACE,
    CHR_b,CHR_o,CHR_t,CHR_h,
    PCT_SPACE,
    CHR_i,CHR_n,
    PCT_SPACE,
    CHR_m,CHR_e,CHR_l,CHR_o,CHR_d,CHR_y,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_0092[] = {
    ...
    CHR_S,CHR_w,CHR_e,CHR_e,CHR_t,
    PCT_SPACE,
    CHR_m,CHR_e,CHR_m,CHR_o,CHR_r,CHR_y,
...
static s16 scenario_text_0098[] = {
    ...
    CHR_S,CHR_w,CHR_e,CHR_e,CHR_t,PCT_SPACE,
    CHR_m,CHR_e,CHR_m,CHR_o,CHR_r,CHR_y,
    PCT_RBRACKET,CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_00E6[] = {
    CTR_EM_RED,
    CHR_O,CHR_H,PCT_EXCLAMATION,PCT_SPACE,
    CHR_G,CHR_o,CHR_r,CHR_g,CHR_e,CHR_o,CHR_u,CHR_s,PCT_SPACE,
    CHR_M,CHR_Y,
    CTR_CLOSE_EM,
    CTR_ENDLINE
};
...
static s16 scenario_text_00E8[] = {
    PCT_SPACE,CTR_EM_BLUE,PCT_SPACE,CHR_O,CHR_H,PCT_EXCLAMATION,PCT_SPACE,
    CHR_G,CHR_o,CHR_r,CHR_g,CHR_e,CHR_o,CHR_u,CHR_s,PCT_SPACE,
    CHR_M,CHR_Y,
    CTR_ENDLINE
};
...
static s16 scenario_text_0112[] = {
    PCT_SPACE,CTR_EM_YELLOW,
    CTR_BLINK,
    CHR_C,CHR_A,CHR_N,CHR_N,CHR_E,CHR_D,
    PCT_SPACE,
    CHR_L,CHR_A,CHR_U,CHR_G,CHR_H,CHR_T,CHR_E,CHR_R,
    PCT_EXCLAMATION,PCT_EXCLAMATION,
    CTR_CLOSE_EM,
    CTR_CLOSE_BLINK,
    CTR_ENDLINE
