...
static s16 scenario_text_00E8[] = {
    PCT_SPACE,CTR_EM_BLUE,PCT_SPACE,PCT_SPACE,
    CHR_O,CHR_H,PCT_EXCLAMATION,
    PCT_SPACE,
    CHR_G,CHR_o,CHR_r,CHR_g,CHR_e,CHR_o,CHR_u,CHR_s,
    PCT_SPACE,
    CHR_M,CHR_y,
...
static s16 scenario_text_0112[] = {
    ...
    CTR_BLINK,
    CHR_W,CHR_A,CHR_R,CHR_A,CHR_I,CHR_G,CHR_O,CHR_E,
    PCT_SPACE,CHR_N,CHR_O,
    PCT_SPACE,CHR_R,CHR_O,CHR_K,CHR_U,CHR_O,CHR_N,
    PCT_EXCLAMATION,PCT_EXCLAMATION,
    CTR_CLOSE_EM,
    CTR_CLOSE_BLINK,
    CTR_ENDLINE
